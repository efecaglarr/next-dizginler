        ...
        <Dialog as='div' className="relative z-10" onClose={closeModal}>
          ...
          <div className='fixed inset-0 overflow-y-auto'>
            <div className='flex min-h-full items-center justify-center p-4 text-center'>
              ...
              >
                <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-8 text-left shadow-xl translate-x-all flex-col gap-5 ">
                  ...
                  <div className='flex-1 flex flex-col gap-2 mt-4'>
                    ...
                    <div className='mt-3 flex flex-wrap gap-4'>
                      ...
                      {Object.entries(car).slice(5).map(([key, value]) => (
